...
// Linear O(n) - directly proportional - as num increases, numer of operations increase - tested with counter
...
// Linear O(n) - directly proportional - as num increases, number of operations increase - tested with counter
...
// Linear O(n) - directly proportional - as str increases, number of operations increase - tested with counter
...
// Linear O(n) - directly proportional - as n increases, number of operations increase - tested with counter
function triangle(n) {
  if (n < 2) 
    return n;
...
// Logarithmic O(log(n)) - as the num increases, run time doesn't grow that much
...
// Polynomial O(n^2) - two recursive calls
...
// Linear O(n) - forEach (recursion) - directly proportional to animalHierarchy input
...
// Linear O(n) - directly proportional, as ogranization input increases, number of operations increases
