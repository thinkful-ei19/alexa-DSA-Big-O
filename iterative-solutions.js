...
//Linear O(n) - directly proportional - bigger the array, longer operation
...
//Linear O(n) - proportional - longer the string, longer the operation
...
//Linear O(n) - directly proportional - bigger the number, higher the operation
function triangle(n) {
  var tot = 0;
  for (var i = 1; i <= n; ++i) {
	    tot += n;
...
//Linear O(n) - directly proportional, longer the string, more operations - tested with counter
...
// Polynomial O(log(n)) - the number is being divided each time so the number of operations is smaller than input
// eliminate part of date each time
...
// Linear O(n) - directly proportional - number of operations depends on input
...
//Linear O(n) - directly proportional - as input increases, number of oerations increases - tested with counter
